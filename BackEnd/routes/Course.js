...
const { CourseSearch, GetPrice, GetCourse, CreateCourse, GetAllCourses, GenerateCourses,userfilterByRatings,userViewCourseRatings,viewPopularCourses} = require('../controller/CourseController')
