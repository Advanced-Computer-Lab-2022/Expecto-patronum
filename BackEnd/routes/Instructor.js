...
const { viewCourses, filterCourses, addCourse, discount, viewCourseRatings,testAll,updateBio,submitAnswer } = require('../controller/InstructorController');
...
router.get("/viewCourses",viewCourses);
 ...
 router.get("/submitAnswer",submitAnswer);
