    ...
    <div className="flip-card-front bg-white z-30  pt-10">
      ...
      <form action="#" method="POST" id="sign-in" className="mt-6 space-y-4 -mx-px bg-white">
        ...
        <div className="flex justify-center  mt-5">
          <MainButton HandleClick={(handleSubmit(Submit))} Loading={Loading} btnText="Login" Size="lg"></MainButton>
        </div>
      ...
      <div className="-scale-x-100 bg-white relative nv:-mt-10">
        ...
        <form action="#" method="POST" id="sign-up" className="mt-6 space-y-5">
          ...
          <div className={"flex justify-end items-center " + " " + (errors.terms && 'text-canadian-red')}>
            <input {...register('terms')} className="mr-2 relative sb:bottom-[0.06125rem]" type='checkbox' />
          ...
          <div className="flex justify-center  mt-5">
            <MainButton HandleClick={(handleSubmit(Submit))} Loading={Loading} btnText="Sign UP" Size="lg"></MainButton>
          </div>
        </form>
      </div>
    </div>
