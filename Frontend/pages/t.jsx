...
const tabs = [
  ...
  { name: 'Discussion Forum', href: '#', current: false },
                    ...
                    {tabs.map((item) => (
                      <li key={item.name}>
                        <div className="flex items-center">
                          ...
                          <a
                            href={item.href}
                            className={item.current?"ml-4 text-sm font-medium text-red-500 underline decoration-2 underline-offset-8":"ml-4 text-sm font-medium text-gray-500 hover:text-gray-700"}
