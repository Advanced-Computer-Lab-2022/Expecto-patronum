...
var radio: null=null;
const requests = [
  { name: 'Jane Cooper', title: 'Regional Paradigm Technician', status: 'Pending', date: '23-12-2022' },
  { name: 'Jane Cooper', title: 'Regional Paradigm Technician', status: 'Pending', date: '23-12-2022' },
  { name: 'Jane Cooper', title: 'Regional Paradigm Technician', status: 'Accepted', date: '23-12-2022' },
  { name: 'Jane Cooper', title: 'Regional Paradigm Technician', status: 'Rejected', date: '23-12-2022' },
  { name: 'Jane Cooper', title: 'Regional Paradigm Technician', status: 'Pending', date: '23-12-2022' },
  ...
  return (
    ...
    <div className="flex">
      ...
      <form id='course-form' className='w-full mx-4 p-20r'>
        ...
        <h6 className='text-center text-2xl text-navbar'>Corporate Trainees' Requests</h6>
