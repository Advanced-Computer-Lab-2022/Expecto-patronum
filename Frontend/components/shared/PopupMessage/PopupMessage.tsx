...
const PopUpMessage = React.forwardRef((props: Props, ref) => {
  ...
  return (
    <div ref={ref as any} className="fixed flex items-center w-[20rem] text-left -right-[21rem] transition-all duration-500 top-22 rounded-md drop-shadow-md shadow-lg h-18 z-30 text-sm bg-white">
        ...
        <p className='mt-4 text-xs text-gray-700 absolute left-16 leading-none pr-2'></p>
