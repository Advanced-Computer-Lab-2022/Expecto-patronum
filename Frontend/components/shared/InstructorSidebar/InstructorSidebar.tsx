...
const InstructorSidebar = (props: Props) => {
  ...
  return (
    <div ref={sidebarRef} className='w-72 sb-max:w-14 text-left text-slate-200 text-xl py-4 px-2 bg-navbar flex border-r-px border-slate-700 flex-col sb-max:absolute left-0 z-40'>
