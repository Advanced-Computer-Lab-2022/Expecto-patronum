...
const MainButton = (props: Props) => {
  return (
    <div onClick={props.HandleClick} className={props.className + ' ' + ButtonCont + " " + (props.Size === 'sm' ? ButtonSm : props.Size === 'md' ? ButtonMd : props.Size === 'lg' ? ButtonLg : ButtonFull)}>
      ...
      </div> : <button className='tracking-wider'>{props.btnText}</button>
      }
