        ...
        <div className='row mx-0'>
            ...
            <div className={column + ' p-4'}>
                ...
                <ul className='text-left mt-4 ml-1 flex flex-wrap'>
                    <li className='text-sm py-1 px-3 my-2 mx-px z-0 scale-125 before:content-[""] before:inline-block before:absolute before:z-behind before:bottom-1 before:right-2.75 before:w-6 before:h-6  before:bg-gray-600 before:rounded-full hover:before:bg-white hover:scale-135 hover:text-gray-600 transition-all duration-300'><button><FaFacebookF /></button></li>
                    <li className='text-sm py-1 px-3 my-2 mx-px z-0 scale-125 before:content-[""] before:inline-block before:absolute before:z-behind before:bottom-1 before:right-2.75 before:w-6 before:h-6  before:bg-gray-600 before:rounded-full hover:before:bg-white hover:scale-135 hover:text-gray-600 transition-all duration-300'><button><FaTwitter /></button></li>
                    <li className='text-sm py-1 px-3 my-2 mx-px z-0 scale-125 before:content-[""] before:inline-block before:absolute before:z-behind before:bottom-1 before:right-2.75 before:w-6 before:h-6  before:bg-gray-600 before:rounded-full hover:before:bg-white hover:scale-135 hover:text-gray-600 transition-all duration-300'><button><FaInstagram /></button></li>
