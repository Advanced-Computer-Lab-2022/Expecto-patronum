            ...
            <div ref={parentRef} className={navbar}>
                ...
                <div className='flex'>
                    ...
                    <div ref={curtainRef} className={navContentDiv}>
                        <a className={navLink} href="/Instructor">Inspire Learners</a>
                        <hr className='nv:hidden' />
                        <a className={navWideButton} href="">Sign Up</a>
                    </div>
                    <div className={navIconsDiv}>
                        <a className={navButton} href=""><AiOutlineUser className={navButtonIcon} /></a>
                        <SelectCountry />
...
const navbar = classNames("relative z-50 flex justify-between items-center nv:px-2 h-16 py-10 shadow-sm");
const navLogoDiv = classNames("nv-max:absolute z-behind 1030:overflow-hidden 1030:w-[3.75rem] transition-all duration-300");
const navLogo = classNames("h-20 bg-main w-fit min-w-fit");
const navContentDiv = classNames("nv-max:absolute z-50 h-full mob:w-screen nv-max-mob:w-fullscreen nv-max:block nv-max:p-2 flex items-center transition-navbar-anime duration-1000 nv-max:bottom-20 nv-max:left-0 nv-max:bg-main ");
