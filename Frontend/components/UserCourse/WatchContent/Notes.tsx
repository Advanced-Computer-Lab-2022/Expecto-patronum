...
const Notes = (props: Props) => {
  let ntoesdata = ["s simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when a", "s simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when a", "s simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when a", "s simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when a", "s simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when a", "s simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when a", "s simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when a", "s simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when a", "s simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when a"]
  ...
  return (
    <div>
      ...
      {AddNote && <div>
        <NoteInput generatePdf={generatePdf} Time={Time} ></NoteInput>
      ...
      <div className={NotesContainer}>
        <NoteInput generatePdf={generatePdf} Time={Time} Written={true} text={"React zew el new"}></NoteInput>
        <NoteInput generatePdf={generatePdf} Time={Time} Written={true} text={"React zew el new"}></NoteInput>
        <NoteInput generatePdf={generatePdf} Time={Time} Written={true} text={"React zew el new"}></NoteInput>
      </div>
